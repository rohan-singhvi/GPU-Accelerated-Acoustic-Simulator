...
You can fine-tune the materials using these flags:

| Flag | Range | Description |
| :--- | :--- | :--- |
| `--absorption` | `0.0 - 1.0` | **Energy lost on bounce.** <br> `0.05` = Polished Marble<br> `0.15` = Concrete (Default)<br> `0.90` = Acoustic Foam / Pillow |
| `--transmission` | `0.0 - 1.0` | **Chance to pass through wall.** <br> `0.0` = Solid Wall (Default)<br> `0.5` = Screen Door / Porous<br> `1.0` = Open Air |

**Example: A thick concrete bunker (High Reflection, No Transmission)**

```bash
./acoustic_sim --absorption 0.05 --transmission 0.0 ...
```

**Example: A tent or screen enclosure (Low Reflection, High Transmission)**

```bash
./acoustic_sim --absorption 0.5 --transmission 0.8 ...
```
